...
rand_landmines = settings.startup["propertyrandomizer-military"].value
...
rand_mining_results_tree_rock = settings.startup["propertyrandomizer-misc-properties"].value
rand_projectiles = settings.startup["propertyrandomizer-military-advanced"].value
rand_stickers = settings.startup["propertyrandomizer-military-advanced"].value
